        ...
        <div className="px-4 py-4 border-t" style={{ borderColor: 'rgba(0,180,216,0.15)' }}>
          <div style={{ fontFamily: 'Noto Sans SC, sans-serif', fontSize: '0.65rem', color: '#475569', lineHeight: 1.7 }}>
            ...
            <a
              ...
              className="flex items-center gap-2 mt-3 px-3 py-2 rounded-sm transition-all duration-200"
              style={{ color: '#94A3B8', textDecoration: 'none', background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)' }}
              onMouseEnter={e => { (e.currentTarget as HTMLAnchorElement).style.color = '#E2E8F0'; (e.currentTarget as HTMLAnchorElement).style.borderColor = 'rgba(0,180,216,0.4)'; (e.currentTarget as HTMLAnchorElement).style.background = 'rgba(0,180,216,0.08)'; }}
              onMouseLeave={e => { (e.currentTarget as HTMLAnchorElement).style.color = '#94A3B8'; (e.currentTarget as HTMLAnchorElement).style.borderColor = 'rgba(255,255,255,0.08)'; (e.currentTarget as HTMLAnchorElement).style.background = 'rgba(255,255,255,0.04)'; }}
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ fontFamily: 'Rajdhani, sans-serif', fontSize: '0.72rem', fontWeight: 600, letterSpacing: '0.04em', lineHeight: 1.2 }}>OWmarket-kline</div>
                <div style={{ fontFamily: 'Orbitron, monospace', fontSize: '0.5rem', color: '#475569', letterSpacing: '0.08em' }}>⭐ STAR ON GITHUB</div>
              </div>
            </a>
          </div>
        </div>
